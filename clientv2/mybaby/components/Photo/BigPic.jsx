...
export default function BigPic({currentPhoto, setCurrentPhoto, source, setIsBig}){
    const setBig = (e) => {
        e.stopPropagation()
        setIsBig(false)
    }
    ...
    return (
        <BigPhoto onClick={(e) => { setBig(e)}} >
            <Container fluid className="mt-2">
                ...
                <img src={source[currentPhoto].photo.replace('localhost', config.serverIP)} alt="sorry" style={{objectFit: "contain",objectPosition: "right top" , width:"100%", height: "100vh"}} />
                     </Col>
